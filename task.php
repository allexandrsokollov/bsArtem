...
<div class="container">
    ...
    <div>
        <div class="row">
            <h3>Капитал-шоу «По́ле чуде́с»</h3>
            <h3> — советская и российская телеигра, выходящая каждую пятницу в 19:45 и являющаяся частичным аналогом
                американской телевизионной программы «Колесо Фортуны».</h3><br>
            <h3>В этой игре вам нужно будет</h3>
            <h3>угадать загаданное слово путем ответа на вопрос. В строчку нужно вводить только одну букву и после
                этого нажимать кнопку "угадать символ", чтобы проверить если эта буква в загаданном слове. После того
                как вы угадаете слово, оно появится целеком, а также выведется количество ваших попыток. Удачи!</h3>
        </div>
